...
const Navbar = (props) => {
  ...
  const closeRegisterModal = () => setOpen(false);
  ...
  return (
    <div>
                ...
                <div className="flex items-center">
                  <Link to="/">
                    <div className="flex-shrink-0">
                      <img className="h-8 w-8" src={SushiLogo} alt="Workflow" />
                    </div>
                  </Link>
      ...
      <LoginPopup open={open} closeModal={closeModal} />
      <RegisterPopup open={openRegister} closeModal={closeRegisterModal} />
    </div>
  );
};
